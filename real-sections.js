(() => {
  ...
  replace('[data-node-id="431:85282"]', `
    <div class="rate-board">
      <h2><img src="figma-assets/rate-raw-2.webp" alt="">Appleギフトカード買取</h2>
  ...
  replace('[data-node-id="392:54873"]', `
    <div class="speed-band" data-node-id="529:20724"><img src="figma-assets/section-heading-band.webp" alt=""><p><small>即日アリアちゃんは</small><strong>振込までがとにかく速い！</strong></p></div>
    <div class="speed-badge"><img src="asset-speed-badge-bg.webp" alt=""><p><small>申込から振込まで、</small><strong>最短<em>3</em>分</strong></p></div>
    <img class="speed-aria" src="asset-speed-aria.webp" alt="案内するアリアちゃん">
    <div class="speed-copy" data-node-id="529:20744"><img class="speed-copy-glow" src="figma-assets/speed-copy-ellipse-529-20744.webp" alt=""><p>Appleギフトカード専門の買取だからこそ<br>実現できるスピードで、<br>待ち時間の不安や急な出費に応えます。</p><small>※繁忙期などお申込みが集中した場合は、<br>入金までお時間をいただく場合がございます。</small></div>`);

  replace('[data-node-id="392:54905"]', `
    <img class="fee-halftone" data-node-id="529:20756" src="figma-assets/fee-halftone-529-20756.webp" alt="">
    <div class="fee-band" data-node-id="529:21781"><img src="figma-assets/fee-band-529-21781@4x.webp" alt=""><p><small>買取率ピッタリで入金</small><strong>振込手数料0円</strong></p></div>
    <div class="fee-glow" data-node-id="529:21780"><img src="figma-assets/fee-copy-ellipse-529-21780.webp" alt=""></div>
    <div class="fee-zero-art" data-node-id="529:21802" aria-label="0円"><span class="fee-zero-bar" data-node-id="529:21803"></span><img class="fee-zero-yen" data-node-id="529:21804" src="figma-assets/fee-yen-529-21804.webp" alt=""><strong data-node-id="529:21805">0</strong></div>
  ...
  replace('[data-node-id="392:55956"]', `
    <img class="reason-halftone" src="asset-flow-halftone-sp-left-top.webp" alt="">
    <div class="reason-band"><img src="figma-assets/section-heading-band.webp" alt=""><p><small>はじめての方でも安心</small><strong>アリアちゃんが選ばれる理由</strong></p></div>
  ...
  replace('[data-node-id="456:89585"]', `
    <img class="flow-dots flow-dots--1" src="asset-flow-halftone-sp-right-top.webp" alt="">
    <img class="flow-dots flow-dots--2" src="asset-flow-halftone-sp-left-top.webp" alt="">
    <img class="flow-dots flow-dots--3" src="asset-flow-halftone-sp-center-bottom.webp" alt="">
    <img class="flow-dots flow-dots--4" src="asset-flow-halftone-sp-right-bottom.webp" alt="">
    <div class="flow-band"><img src="figma-assets/section-heading-band.webp" alt=""><p><small>あっという間に振込完了！</small><strong>お申し込みの流れ</strong></p></div>
    ...
    <span class="flow-cta-glow" data-node-id="529:27016"><img src="figma-assets/flow-cta-glow-529-27016.webp" alt=""></span>
    <a class="flow-cta-exact" href="#estimate" data-node-id="529:27017"><span class="flow-cta-surface" data-node-id="529:27019"><img src="figma-assets/flow-cta-chevrons-529-27020.webp" alt=""><strong data-node-id="529:27027">お申し込みはこちら</strong></span></a>`);

  replace('[data-node-id="392:61195"]', `
    <img class="repeat-corner" src="figma-assets/repeat-corner.webp" alt="">
    ...
    <div class="repeat-circle repeat-circle--gift">
      <img src="figma-assets/repeat-circle-top.webp" alt="">
      <span class="gift-card"><b>GIFTCODE</b><i>＊＊＊＊＊＊＊＊</i></span>
      <strong>ギフトコード</strong>
    </div>
    <div class="repeat-circle repeat-circle--bank">
      <img class="repeat-circle-bg" src="figma-assets/repeat-circle-bank.webp" alt="">
      <span class="bank-icon"><img src="figma-assets/repeat-bank-2.webp" alt=""><img src="figma-assets/repeat-bank-1.webp" alt=""><img src="figma-assets/repeat-bank-column.webp" alt=""><img src="figma-assets/repeat-bank-column.webp" alt=""><img src="figma-assets/repeat-bank-3.webp" alt=""></span>
      <strong>銀行口座</strong>
    </div>
    <div class="repeat-circle repeat-circle--amount">
      <img class="repeat-circle-bg" src="figma-assets/repeat-circle-top.webp" alt="">
      <img class="yen-icon" src="figma-assets/repeat-yen.webp" alt="">
      <strong>金額</strong>
    </div>
  ...
  const faq = replace('[data-node-id="392:61241"]', `
    <img class="faq-title-glow" src="figma-assets/faq-title-glow.webp" alt="">
    <h2 class="faq-title">よくある質問</h2>
    <div class="faq-list">${faqs.map(([question,answer],i)=>`<div class="faq-item faq-item--${i+1}"><button class="faq-summary" type="button" aria-expanded="false"><span class="faq-q"><img src="figma-assets/faq-q-circle.webp" alt=""><b>Q</b></span><strong>${question}</strong><i class="faq-toggle"></i></button><p class="faq-answer">${answer}</p></div>`).join('')}</div>`);
    ...
    <div class="news-list">${newsItems.map(({ date, datetime, title, body }, index) => `
      <details class="news-item news-item--${index + 1}">
        <summary class="news-summary">
          <span class="news-row"><strong>${title}</strong><img src="figma-assets/news-chevron.webp" alt=""></span>
  ...
  const companyRows = [
    ...
    ['営業時間', '<span>07:00 ～ 22:00（土日祝も営業）</span><span class="company-hours">毎月1日は24時間営業いたします。<img src="figma-assets/company-hours-line.webp" alt=""></span>'],
    ['設立', '2020年6月9日'],
    ['代表取締役', '大附　俊幸'],
  ...
  replace('[data-node-id="392:61338"]', `
    ...
    <figure class="company-building"><img src="figma-assets/company-building.webp" alt="呉羽小野木ビル外観"></figure>
